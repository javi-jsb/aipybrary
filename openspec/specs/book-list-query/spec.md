...
Define the pagination, filtering, and sorting capabilities for the `GET /books` endpoint. This spec covers the query contract — what parameters are accepted, how results are shaped, and the rules governing each behaviour.
