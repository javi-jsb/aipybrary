...
Expose a lightweight HTTP endpoint that reports whether the service process is currently running and able to handle requests. This is a liveness probe used by orchestrators, load balancers, and uptime monitors; readiness and dependency checks are out of scope and belong to a separate capability.
